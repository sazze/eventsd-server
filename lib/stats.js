...
Tracker.prototype.updateEventStats = function (msg) {
  ...
  if (_.isUndefined(this.eventsSent[msg.routingKey])) {
    this.eventsSent[msg.routingKey] = 0;
    this.eventsSentThisHour[msg.routingKey] = 0;
    this.eventsSentThisMinute[msg.routingKey] = 0;
  }

  this.eventsSent[msg.routingKey]++;
  this.eventsSentThisHour[msg.routingKey]++;
  this.eventsSentThisMinute[msg.routingKey]++;
};
