...
Tracker.prototype.printStats = function (raw) {
  var stats = "Sent:\n" + this.totalHourlyStats.allStats(raw) + " /hr\n" + this.totalMinutelyStats.allStats(raw) + " /min\n";

  //TODO: list per event type stats
  //stats += "\nPer Event Stats:\n" + _.forEach(this.eventsHourlyStats);

  stats += "Drop:\n" + this.totalHourlyDropStats.allStats(raw) + " /hr\n" + this.totalMinutelyDropStats.allStats(raw) + " /min\n";
